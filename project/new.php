...
<div class="header-content">
    <div class="logo">
        <img src="src/images/logo.png" alt="Book Haven Logo">
    </div>
...
<nav>
    <ul>
        ...
        <li><a href="#">Help</a></li>
        <li class="admin-option"><a href="new.php">Admin <i class="fas fa-cogs"></i></a></li>
    </ul>
</nav> -->
            ...
            <div class="col-md-3">
              <div class="information">
                ...
                <ul>
                  ...
                  <li><a href="file:///C:/xampp/htdocs/project/index.html#">Privacy Policy</a></li>
